...
public:
  ...
  bool isAlaioContract() const { return hasAttr<AlaioContractAttr>(); }
  bool isAlaioAction() const { return hasAttr<AlaioActionAttr>(); }
  bool isAlaioTable() const { return hasAttr<AlaioTableAttr>(); }
  bool isAlaioIgnore() const { return hasAttr<AlaioIgnoreAttr>(); }
  bool hasAlaioRicardian() const { return hasAttr<AlaioRicardianAttr>(); }
  AlaioActionAttr* getAlaioActionAttr() const { return getAttr<AlaioActionAttr>(); }
  AlaioTableAttr*  getAlaioTableAttr() const { return getAttr<AlaioTableAttr>(); }
  AlaioContractAttr*  getAlaioContractAttr() const { return getAttr<AlaioContractAttr>(); }
  AlaioRicardianAttr*  getAlaioRicardianAttr() const { return getAttr<AlaioRicardianAttr>(); }
