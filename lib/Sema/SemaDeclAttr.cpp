...
static void handleAlaioRicardianAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  ...
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
   ...
   D->addAttr(::new (S.Context)
                 AlaioRicardianAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleAlaioContractAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 AlaioContractAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleAlaioActionAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 AlaioActionAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}

static void handleAlaioTableAttribute(Sema &S, Decl *D, const AttributeList &AL) {
  // Handle the cases where the attribute has a text message.
  StringRef Str, Replacement;
  if (AL.isArgExpr(0) && AL.getArgAsExpr(0) &&
      !S.checkStringLiteralArgumentAttr(AL, 0, Str))
  ...
  D->addAttr(::new (S.Context)
                 AlaioTableAttr(AL.getRange(), S.Context, Str,
                                AL.getAttributeSpellingListIndex()));
}
...
static void ProcessDeclAttribute(Sema &S, Scope *scope, Decl *D,
  ...
  default:
    ...
    break;
  case AttributeList::AT_AlaioIgnore:
    handleSimpleAttribute<AlaioIgnoreAttr>(S, D, AL);
    break;
  case AttributeList::AT_AlaioAction:
    handleAlaioActionAttribute(S, D, AL);
    break;
  case AttributeList::AT_AlaioTable:
    handleAlaioTableAttribute(S, D, AL);
    break;
  case AttributeList::AT_AlaioContract:
    handleAlaioContractAttribute(S, D, AL);
    break;
  case AttributeList::AT_AlaioRicardian:
    handleAlaioRicardianAttribute(S, D, AL);
    break;
